	...
	var i = {
			...
			show: function (t, e) {
				...
				var r,
					...
					l =
						...
						{
							top: c.top + u.pageYOffset - s.clientTop,
							left: c.left + u.pageXOffset - s.clientLeft,
						}),
					m = t.pageY - l.top,
					f = t.pageX - l.left,
					p = "scale(" + (n.clientWidth / 100) * 10 + ")";
				"touches" in t &&
					((m = t.touches[0].pageY - l.top), (f = t.touches[0].pageX - l.left)),
					o.setAttribute("data-hold", Date.now()),
					o.setAttribute("data-scale", p),
					o.setAttribute("data-x", f),
					o.setAttribute("data-y", m);
				var v = { top: m + "px", left: f + "px" };
				(o.className = o.className + " waves-notransition"),
					o.setAttribute("style", a(v)),
					(o.className = o.className.replace("waves-notransition", "")),
					(v["-webkit-transform"] = p),
					(v["-moz-transform"] = p),
					(v["-ms-transform"] = p),
					(v["-o-transform"] = p),
					(v.transform = p),
					(v.opacity = "1"),
					(v["-webkit-transition-duration"] = i.duration + "ms"),
					(v["-moz-transition-duration"] = i.duration + "ms"),
					(v["-o-transition-duration"] = i.duration + "ms"),
					(v["transition-duration"] = i.duration + "ms"),
			...
			hide: function (t) {
				...
				var e = this,
					...
					r = e.getElementsByClassName("waves-ripple");
				if (!(r.length > 0)) return !1;
				var s = (n = r[r.length - 1]).getAttribute("data-x"),
	...
	(e.displayEffect = function (e) {
		...
		(e.attach = function (e) {
			"input" === e.tagName.toLowerCase() &&
				(i.wrapInput([e]), (e = e.parentElement)),
...
/*! AnimateCSS */
const animateCSS = (n, e, a = "animate__") =>
	new Promise((t, i) => {
		const o = `${a}${e}`,
			s = document.querySelector(n);
		s.classList.add(`${a}animated`, o),
			s.addEventListener(
				"animationend",
				function (n) {
					n.stopPropagation(),
						s.classList.remove(`${a}animated`, o),
						t("Animation ended");
				},
				{ once: !0 }
			);
